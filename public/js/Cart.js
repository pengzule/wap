...
function increase(obj){
	...
	$.ajax({
		type: "GET",
		url: '/service/cart/change',
		dataType: 'json',
		cache: false,
		data: { product_id:basket_id,type:type,_token: "{{csrf_token()}}"},
...
function disDe(obj){
	...
	$.ajax({
		...
		dataType: 'json',
		cache: false,
		data: { product_id:basket_id,type:type,count:count,_token: "{{csrf_token()}}"},
		success: function(data) {
			console.log(data);
			if(data == null) {
				$('.bk_toptips').show();
...
function changeShopCartNumber(_basketId,type){
	var config = false;
	$.ajax({
		type: "GET",
		url: '/service/cart/change',
		dataType: 'json',
		cache: false,
		data: { product_id:_basketId,type:type,_token: "{{csrf_token()}}"},
		success: function(data) {
			console.log(data);
			if(data == null) {
				$('.bk_toptips').show();
